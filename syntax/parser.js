...
const astGenerator = grammar.createSemantics().addOperation('ast', {
  ...
  Stmt_while(_, test, block) { return new WhileStatement(test.ast(), block.ast()); },
  Stmt_from(_1, firstTest, _2, secondTest, _3, increments, Block ) { 
  ...
  Block_small(_1, statement, _2) { return [statement.ast()]; },
  Block_large(_1, _2, _3, statements, _4) { return statements.ast(); },
  ...
  Exp5_unary(operand, op) { return new UnaryExpression(op.ast(), operand.ast()); },
  Exp6_list(_1, expressions, _2) { return new ListExpression(expressions.ast()); },
  Exp6_parens(_1, expression, _2) { return expression.ast(); },
  FunctionType(_1, args, _2) { return FunctionType(args.ast()); },
